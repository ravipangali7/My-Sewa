  ...
  head: () => ({
    meta: [
      { title: "Load Wallet — MySewa" },
      {
        name: "description",
        content:
          "Load your MySewa wallet by submitting a manual deposit with payment proof for admin approval.",
      },
      { property: "og:title", content: "Load Wallet — MySewa" },
      {
        property: "og:description",
        content: "Submit a manual wallet load request with payment proof.",
      },
    ],
  }),
...
function LoadWallet() {
  ...
  const activeSource: DestSource =
    canChooseDealer && destSource === "dealer" ? "dealer" : "platform";
